...
function calculateLanguageStats(repos, languagesData) {
  ...
  // Sum up all bytes for each language
...
module.exports = async (req, res) => {
  try {
    const { username, theme = 'default', hide_border, title, card_width } = req.query;

    if (!username) {
      const errorSvg = `<svg width="495" height="100" xmlns="http://www.w3.org/2000/svg">
